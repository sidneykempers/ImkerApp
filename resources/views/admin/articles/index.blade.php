                    ...
                    <tbody class="bg-white divide-y">
                        @foreach($posts as $post)
                            <tr class="text-gray-700">
                                ...
                                <td class="px-4 py-3 text-sm"><a href="{{ route('article.show',['id' => $post->id]) }}">Details</a></td>
                                <td class="px-4 py-3 ">
                                    <div class="flex items-center space-x-4 text-sm">
                                        <a href="{{ route('article.edit', ['id' => $post->id]) }}">
                                ...
                                <td class="px-4 py-3 ">
                                    <div class="flex items-center space-x-4 text-sm">
                                        <a href="">
                                            <form action="{{route('article.delete', ['id' => $post->id])}}"  method="post">
                                            @csrf
