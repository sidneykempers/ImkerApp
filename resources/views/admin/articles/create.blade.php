            ...
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                <div class="sm:block sm:ml-6">
                    <div class="flex space-x-4">
                        ...
                        <a href="/admin/article/create" class="text-gray-800 hover:text-teal-600 transition ease-in-out duration-500 px-3 py-2 rounded-md text-sm font-medium" aria-current="page">Post toevoegen</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <label class="block text-sm">
                 ...
                 <label class="block text-sm">
                    ...
                    @error('Short_description') border-red-600 focus:border-red-400 focus:shadow-outline-red @enderror"
                            name="short_description" value="{{ old('short_description') }}" type="text" required/>
                 ...
                 <label class="block text-sm">
                    ...
                    @error('post_data') border-red-600 focus:border-red-400 focus:shadow-outline-red @enderror"
                               name="post_data" required>{{ old('post_data') }} </textarea>
                 ...
                 <label class="block text-sm">
                    ...
                    @error('tags') border-red-600 focus:border-red-400 focus:shadow-outline-red @enderror"
                            name="tags" value="{{ old('tags') }}" type="text" required/>
